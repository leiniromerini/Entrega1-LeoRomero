...
from productos.views import productos_all,create_product, search_product,listar_herramientas,search_herramientas,create_herramientas,listar_muebles, search_muebles
